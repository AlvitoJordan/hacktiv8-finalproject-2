  ...
  return (
    ...
    <nav className="flex items-center justify-between w-full px-3 py-3 mx-auto max-w-8xl lg:px-4 border-b-2">
      <div className="flex items-center">
        <div className="flex items-center justify-between">
          <a href="/" className="flex">
            ...
            <span className="hidden md:flex self-center text-2xl font-semibold whitespace-nowrap dark:text-black logo">
              Bukapedia
            </span>
          </a>
        </div>
        <div className="ml-2 md:ml-6 md:flex">
          <div className="w-[300px] md:w-[345px] relative">
            ...
            <Button
              type="btn-iconOnly"
              content="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"
            />
          </div>
        </div>
      </div>
      <div className="flex items-center">
        ...
        <a
          href="/"
          className="hidden lg:inline-flex items-center bg-primary hover:bg-secondary text-vanilla font-semibold py-2 px-8 border-2 border-transparent rounded-md shadow ml-5"
        >
          Login
        </a>
      </div>
