...
const Card = (props) => {
  ...
  return (
    <div className="max-w-sm rounded-lg overflow-hidden shadow-box_item">
      ...
      <div className="flex flex-row justify-end gap-3 mt-6 px-6 pt-4 pb-4">
        <Button className="bg-primary hover:bg-secondary text-white font-semibold py-2 px-3 border-2 border-transparent rounded-md shadow ml-5">
          Detail
        </Button>
