...
const CartContent = (props) => {
  ...
  return (
    <>
      <div
        className={`grid grid-cols-[2fr_0.1fr_1fr_1fr_1fr_0.1fr] items-center justify-center border p-5 rounded-md border-lightgray my-2  max-[768px]:flex max-[768px]:flex-col max-[768px]:items-start max-[768px]:relative ${
          active === false ? "" : "border-red-600 "
        }`}
      >
