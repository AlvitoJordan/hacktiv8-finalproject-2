...
import { DeleteIcon, Warning } from "../../assets";
import NumberInput from "./NumberInput";
import SideProduct from "./SideProduct";

const CartContent = (props) => {
  const { img, title, categories, price, total, value, onDecrement, onIncrement, onChange, deleteProduct, active } = props;
  return (
    <>
